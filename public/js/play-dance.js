var play = function (option) {
    ...
    var audioInfo = option.music || '一首无言的歌';
...
//---
    ...
    function userStart() {
        ...
        audioSetup( 'http://static.missevan.com/sound/201706/02/6c0fe0b5bf8e8a7ebed65155520497b3222135.mp3' );
...
//---
    ...
    function onResize(){
        ...
        // w =  window.getComputedStyle(parentNode).width px

        w = canvas.parentNode.clientWidth || window.innerWidth || document.documentElement.clientWidth
...
//---
    ...
    // init();
    play.prototype.start = function (music_url) {
        init(music_url)
    }
}
